...
class S051Page extends StatefulWidget {
  S051Page({Key key, this.number}) : super(key: key);
  final String number;
  @override
  _S051PageState createState() => _S051PageState(number1: number);
}

class _S051PageState extends State<S051Page>{

  _S051PageState({this.number1});
