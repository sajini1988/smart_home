...
class MoodS160Page extends StatefulWidget {
  MoodS160Page({Key key, this.number}) : super(key: key);
  final String number;
  @override
  _MoodS160PageState createState() => _MoodS160PageState(number1: number);
}
class _MoodS160PageState extends State<MoodS160Page> {

  _MoodS160PageState({this.number1});
  ...
  Image img1On,img1Off,img2On,img2Off,img3On,img3Off,img4Off,img4On,img5Off,img5On,img6Off,img6On,img7Off,img7On;
