...
class MoodS010Page extends StatefulWidget {

  MoodS010Page({Key key, this.number}) : super(key: key);
  final String number;
  @override
  _MoodS010PageState createState() => _MoodS010PageState(number1: number);
}

class _MoodS010PageState extends State<MoodS010Page> {

  _MoodS010PageState({this.number1});
