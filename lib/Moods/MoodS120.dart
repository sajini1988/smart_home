...
class MoodS120Page extends StatefulWidget {
  MoodS120Page({Key key, this.number}) : super(key: key);
  final String number;
  @override
  _MoodS120PageState createState() => _MoodS120PageState(number1: number);
}
class _MoodS120PageState extends State<MoodS120Page> {

  _MoodS120PageState({this.number1});
