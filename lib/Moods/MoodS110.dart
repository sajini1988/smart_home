...
class MoodS110Page extends StatefulWidget {
  MoodS110Page({Key key, this.number}) : super(key: key);
  final String number;
  @override
  _MoodS110PageState createState() => _MoodS110PageState(number1: number);
}
class _MoodS110PageState extends State<MoodS110Page> {

  _MoodS110PageState({this.number1});
