...
class S051TimerPage extends StatefulWidget {

  S051TimerPage({Key key, this.number}) : super(key: key);
  final String number;

  @override
  _S051TimerPageState createState() => _S051TimerPageState(number1: number);
}

class _S051TimerPageState extends State<S051TimerPage>{

  _S051TimerPageState({this.number1});
