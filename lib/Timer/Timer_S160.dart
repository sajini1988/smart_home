...
class TimerS160Page extends StatefulWidget {

  TimerS160Page({Key key, this.number}) : super(key: key);
  final String number;

  @override
  _TimerS160PageState createState() => _TimerS160PageState(number1: number);
}
class _TimerS160PageState extends State<TimerS160Page> {

  _TimerS160PageState({this.number1});
  ...
  String sw1ondata,sw1offdata,sw2ondata,sw2offdata,sw3ondata,sw3offdata,sw4ondata,sw4offdata,sw5ondata,sw5offdata,sw6ondata,sw6offdata,sw7ondata,sw7offdata,sw1n,sw2n,sw3n,sw4n,sw5n,sw6n,sw7n;
