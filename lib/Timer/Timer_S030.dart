...
class TimerS030Page extends StatefulWidget {

  TimerS030Page({Key key, this.number}) : super(key: key);
  final String number;

  @override
  _TimerS030PageState createState() => _TimerS030PageState(number1: number);
}
class _TimerS030PageState extends State<TimerS030Page> {

  _TimerS030PageState({this.number1});
