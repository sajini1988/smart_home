...
class TimerS020Page extends StatefulWidget {

  TimerS020Page({Key key, this.number}) : super(key: key);
  final String number;

  @override
  _TimerS020PageState createState() => _TimerS020PageState(number1:number);
}
class _TimerS020PageState extends State<TimerS020Page> {

  _TimerS020PageState({this.number1});
