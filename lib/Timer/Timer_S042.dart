...
class TimerS042Page extends StatefulWidget {

  TimerS042Page({Key key, this.number}) : super(key: key);
  final String number;

  @override
  _TimerS042PageState createState() => _TimerS042PageState(number1: number);
}

class _TimerS042PageState extends State<TimerS042Page> {

  _TimerS042PageState({this.number1});
  ...
  Image img1On,img1Off,img2On,img2Off,img3On,img3Off,img4On,img4Off;
  ...
  String sw1ondata,sw1offdata,sw2ondata,sw2offdata,sw3ondata,sw3offdata,sw4ondata,sw4offdata,fanondata1="",fanoffdata1="",fanondata2="",fanoffdata2="";
  String sw1n,sw2n,sw3n,sw4n,fanswn1,fanswn2;
  ...
  fanspeed(){
    if(fanondata1.length == 0){
      ...
      if(dropdownValue=="0"){
        ...
        print("zero");
        ondataarray.remove(fanondata1);
        offdataarray.remove(fanoffdata1);
        switchnumber.remove(fanswn1);
  ...
  fandata(){
    ...
    fanondata1=sendDataSwitchBoard(ondatafan, "01");
    fanoffdata1=sendDataSwitchBoard("723", "01");
    fanswn1="98";

    ondataarray.add(fanondata1);
    offdataarray.add(fanoffdata1);
    switchnumber.add(fanswn1);
