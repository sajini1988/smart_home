...
import 'package:smart_home/Wireless3MSwitch/W3MSwitch.dart';

class WS03IView extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  details()async{
    ...
    DBHelper dbHelper;
    dbHelper = DBHelper();
    List result = await dbHelper.getLocalDateHName(hname30);
