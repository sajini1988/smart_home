...
class S080 extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> updateswb_5_8(int i, bool sb5, bool sb55, bool sb6, bool sb66, bool sb7, bool sb77, bool sb8, bool sb88) async {
    ...
    if (sb8) {
      if (sb88) {
        imagechageOn(icon8,"8",img8_On);
      }
      else {
        imagechangeOff(icon8,"8",img8_Off);
      }
      sb8 = false;
                ...
                child: Row(
                  ...
                  children: [
                    Padding(padding: const EdgeInsets.all(05.0),
                      child:GestureDetector(
                        onLongPress: (){
                          _globalService.bulbnumberset="b7t";
                          showAlertDialog(context);
                        },
                        child:Transform.scale(
                          scale: 2.5,
                    ...
                    Padding(padding: const EdgeInsets.all(05.0),
                      child:GestureDetector(
                        onLongPress: (){
                          _globalService.bulbnumberset="b8t";
                          showAlertDialog(context);
                        },
                        child:Transform.scale(
                          scale: 2.5,
                          child: IconButton(
                            ...
                            splashColor:Colors.transparent ,
                            onPressed: () {
                              SendDataSw(senddata: "108", CastType: "01");
                            }
                          ),
                        ),
