...
class DFN1 extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Image imagefanon1  = Image.asset('images/switchicons/fan1.png');
  Image imagefanoff1 = Image.asset('images/switchicons/fan0.png');
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Transform.scale(scale: 1.40,
                            child: IconButton(
                              iconSize: MediaQuery.of(context).size.width/10,
                              icon:fanimgChange2?imagefanon1:imagefanoff1,
                              splashRadius: 0.1,
                              splashColor:Colors.transparent ,
                              onPressed: (){
